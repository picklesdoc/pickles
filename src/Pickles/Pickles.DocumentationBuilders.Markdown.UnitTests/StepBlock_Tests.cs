...
namespace PicklesDoc.Pickles.DocumentationBuilders.Markdown.UnitTests
{
    ...
    public class StepBlock_Tests
    {
        ...
        public void The_Step_Is_Formatted()
        {
            ...
            Assert.AreEqual(1, actualString.Length);
        }
        ...
        public void A_Step_Table_Is_Formatted()
        {
            ...
            stepTable.HeaderRow = new ObjectModel.TableRow(new[] { "Col1", "Col2" });
            stepTable.DataRows = new System.Collections.Generic.List<ObjectModel.TableRow>();
            stepTable.DataRows.Add(new ObjectModel.TableRow(new[] { "Col1Row1", "Col2Row1" }));
            stepTable.DataRows.Add(new ObjectModel.TableRow(new[] { "Col1Row2", "Col2Row2" }));
            ...
            Assert.AreEqual(6, actualString.Length);
        }
    }
}
