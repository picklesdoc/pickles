//  --------------------------------------------------------------------------------------------------------------------
//  <copyright file="WhenParsingVsTestResultsFile.cs" company="PicklesDoc">
...
{
    [TestFixture]
    public class WhenParsingVsTestResultsFile : StandardTestSuite<VsTestResults>
    {
        public WhenParsingVsTestResultsFile()
            : base("VsTest." + "results-example-vstest.trx")
        {
        }
