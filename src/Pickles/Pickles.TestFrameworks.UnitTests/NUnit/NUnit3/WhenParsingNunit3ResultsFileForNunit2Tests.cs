...
{
    [TestFixture]
    public class WhenParsingNunit3ResultsFileForNunit2Tests : StandardTestSuite<NUnit3Results>
    {
        public WhenParsingNunit3ResultsFileForNunit2Tests()
            : base("NUnit.NUnit3." + "results-example-nunit2-with-nunit3-runner.xml")
        {
        }
